...
<template>
  <ComboboxRoot class="relative">
    <ComboboxAnchor
      class="w-full inline-flex items-center justify-between border text-xs leading-none h-12 bg-(--BG_White_Color) rounded-r-[15px] gap-[5px] text-grass11 hover:bg-stone-50 shadow-sm focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-grass9 outline-none"
    >
      <ComboboxInput
        class="!bg-transparent outline-none text-grass11 h-full selection:bg-grass5 placeholder-stone-400 h-full text-black"
        placeholder="Placeholder..."
      />
      <ComboboxTrigger class="h-full">
        <Icon
          name="radix-icons:chevron-down"
          class="h-6 w-6 text-grass11 text-black"
        />
      </ComboboxTrigger>
    </ComboboxAnchor>
