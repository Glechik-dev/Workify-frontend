...
<template>
  ...
  >
    <NuxtImg src="/logo (1).png" class="absolute bottom-[20%] right-[-90px]" />
    <NuxtImg src="/logo (1).png" class="absolute top-[30%] left-[-90px]" />
      ...
      >
        ...
        <div class="w-[540px] px-[60px] py-[70px] flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-4 relative">
            <div
              class="absolute w-[130px] h-[1px] bg-white left-0 top-[16px]"
            ></div>
            <div
              class="absolute w-[130px] h-[1px] bg-white right-0 top-[16px]"
            ></div>
            <div class="w-full flex justify-center text-2xl">Увійти через</div>
